<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="msubcs_registro2.aspx.vb" Inherits="MAS_PMSU.msubcs_registro2" %>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                                ...
                                                <Columns>                                             
                                                    ...
                                                    <asp:BoundField DataField="Productor" HeaderText="NOMBRE DE OP O NOMBRE DE PRODUCTOR" />
                                                    <asp:BoundField DataField="TIPO_BCS" HeaderText="TIPO_BCS" />
