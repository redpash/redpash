<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="msu_entregas.aspx.vb" Inherits="MAS_PMSU.msu_entregas" %>
    ...
    <div class="row">
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="QQ_entregado" HeaderText="QQ ENTREGADO" DataFormatString="{0:0.00}" />

                                        <asp:BoundField DataField="cumplimiento" HeaderText="%  ORO" DataFormatString="{0:0.00}" />
                                         <asp:BoundField DataField="cumplimiento consumo" HeaderText="%  CONSUMO" DataFormatString="{0:0.00}" />
      ...
      <asp:UpdatePanel ID="UpdatePanel2"
                    ...
                    <div class="panel-body">
                               ...
                               Identificacion 
                                  ...
                                  Producción
                                       ...
                                       <div class="col-lg-2">
                                         ...
                                         <div class="panel panel-primary">
                                        <div class="panel-heading">
                                  Detalle ORO (semilla certificada)
                                            ...
                                            <div class="col-lg-2">
                                              ...
                                              <div class="col-lg-2">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox CssClass="form-control" ID="txt_qq_oro_pend" runat="server" AutoPostBack="True" ReadOnly="True"></asp:TextBox>
                                                </div>
                                            </div>

                                            <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label>Precio venta QQ oro</label>
                        ...
                        <div class="col-lg-2">
                                  ...
                                  Detalle consumo
                                              ...
                                              <div class="col-lg-2">
                                                ...
                                                <div class="form-group">
                                                    <label>QQ consumo pendiente</label>
                                                     <asp:TextBox CssClass="form-control" ID="qq_consumo_pend" runat="server"  AutoPostBack="True" ReadOnly="true"></asp:TextBox>
                                                </div>
                                            </div>
                                              ...
                                              <div class="col-lg-2">
                                                <div class="form-group">
                                                    <label>Precio venta QQ consumo</label>
       ...
       <div id="div_guardar" runat="server">
               <asp:Button ID="Guardar_registro"  class="btn btn-success" runat="server" Text="Guardar" />
