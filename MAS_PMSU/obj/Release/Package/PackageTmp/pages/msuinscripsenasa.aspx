<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="msuinscripsenasa.aspx.vb" Inherits="MAS_PMSU.msuinscripsenasa" %>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:DropDownList CssClass="form-control" ID="TxtCiclo" runat="server" AutoPostBack="True">
                                    ...
                                    <asp:ListItem>2018-Ciclo A</asp:ListItem>
                                    <asp:ListItem>2018-Ciclo B</asp:ListItem>
                                    <asp:ListItem>2018-Ciclo C</asp:ListItem>
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="PRONOSTICO_COSECHA" HeaderText="PRONOSTICO COSECHA" DataFormatString="{0:0.00}" />
