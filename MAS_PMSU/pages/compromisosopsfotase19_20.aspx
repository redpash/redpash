<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="compromisosopsfotase19_20.aspx.vb" Inherits="MAS_PMSU.compromisosopsfotase19_20" %>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    REGISTRO DE COMPROMISO OPS FORTALECIDAS CAFE 19-20
                </div>
                <div class="panel-body">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <br />
                                    <label for="TxtComp">
                                        # Productores con compromiso</label>
                                    <asp:TextBox ID="Txtnprod" runat="server" CssClass="form-control" onkeypress="return numericOnly(this);" autocomplete="off" />
                                    <br />
                                    <label for="TxtComp2">
                                        QQ comprometidos</label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <script type="text/javascript">
                                $(function () {
                                    var tabName = $("[id*=TabName]").val() != "" ? $("[id*=TabName]").val() : "OP2";
