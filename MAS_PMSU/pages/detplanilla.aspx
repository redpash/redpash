<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="detplanilla.aspx.vb" Inherits="MAS_PMSU.detplanilla" %>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    REGISTRO DE COMPROMISO OPS 19-20
                </div>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="table-responsive">
                                                            ...
                                                            <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                                                ...
                                                                <Columns>                                                                  
                                                                    <asp:BoundField DataField="Depto_Descripcion" HeaderText="Depto_Descripcion" />
                                                                    <asp:BoundField DataField="ec_codigo" HeaderText="ec_codigo" />
                                                                    <asp:BoundField DataField="ec_nombre" HeaderText="ec_nombre" />
                                                                    <asp:BoundField DataField="Entrenamientos" HeaderText="Entrenamientos" />                                                                   
                                                                </Columns>
                                                                <EditRowStyle BackColor="#7C6F57" />
                                                            </asp:GridView>
                                                        </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <asp:GridView ID="GridDatos3" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="TIPO_CAFE" HeaderText="TIPO_CAFE" />
