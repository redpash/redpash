<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="compfrijolprimasefconv2019.aspx.vb" Inherits="MAS_PMSU.compfrijolprimasefconv2019" %>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ACTUALIZACION DE CONVENIOS A OP'S DE FRIJOL FORTALECIDAS CON COMPROMISOS
                </div>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="CONTRATO_OP" HeaderText="CONTRATO_OP" />
                                                    <asp:BoundField DataField="QQ_COMPROMETIDOS" HeaderText="QQ_COMPROMETIDOS" DataFormatString="{0:0.00}" />
                                                </Columns>
