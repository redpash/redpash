<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="compfrijolprimaseconv2019.aspx.vb" Inherits="MAS_PMSU.compfrijolprimaseconv2019" %>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ACTUALIZACION DE CONVENIOS A OP'S DE FRIJOL CON COMPROMISOS
                </div>
                        ...
                        <div class="tab-pane fade in active" id="Datos">
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Seleccione el Comprador:</label>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                                ...
                                                <%--    <asp:ButtonField ButtonType="Button" Text="Editar" ControlStyle-CssClass="btn btn-warning" HeaderText="Editar" CommandName="Editar">
                                                    ...
                                                    <asp:BoundField DataField="QQ" HeaderText="QQ" DataFormatString="{0:0.00}" />
                                                </Columns>
