...
Public Class compromisosopsfotase19_20
    ...
    Private Sub llenarcomboDepto()
        Dim StrCombo As String = "SELECT '00' as Depto_Cod, 'Todos' as Depto_Descripcion UNION SELECT DISTINCT Depto_Cod ,Depto_Descripcion FROM `masops_fortalecidas` WHERE CADENA='CAFE' "
    ...
    Private Sub llenarcomboEntrenador()
        Dim StrCombo As String = "SELECT '00' as ec_codigo,' Todos' as ec_nombre UNION SELECT DISTINCT ec_codigo, ec_nombre FROM `masops_fortalecidas` WHERE Depto_Cod = '" & TxtDepto.SelectedValue & "' AND CADENA='CAFE' ORDER BY ec_nombre "
        Dim adaptcombo As New MySqlDataAdapter(StrCombo, conn3)
        Dim DtCombo As New DataTable
        adaptcombo.Fill(DtCombo)
    ...
    Private Sub llenarcomboOP()
        Dim StrCombo As String = "SELECT '00' as COD_ORGANIZACION,' Todas' as OP_NOMBRE UNION SELECT DISTINCT COD_ORGANIZACION, OP_NOMBRE FROM `masops_fortalecidas` WHERE Depto_Cod = '" & TxtDepto.SelectedValue & "' and ec_codigo = '" & TxtEntrenador.SelectedValue & "' AND CADENA='CAFE' ORDER BY OP_NOMBRE "
        Dim adaptcombo As New MySqlDataAdapter(StrCombo, conn3)
        Dim DtCombo As New DataTable
        adaptcombo.Fill(DtCombo)
    ...
    Sub llenagrid()
        ...
        '    "FROM `mas+cafecomp19_20prod` ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
        'Else
    ...
    Sub llenagrid3()
        ...
        If TxtDepto.SelectedValue = "00" Then
            ...
            "FROM `mas+cafecompf19_20ops` ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
        Else
            If TxtEntrenador.SelectedValue = "00" Then

                Me.SqlDataSource3.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,TIPO_CAFE,EXPORTADOR,COMPROMISO " +
                "FROM `mas+cafecompf19_20ops` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
            Else
                If (cmborganizacion.SelectedValue = "00") Then
                    Me.SqlDataSource3.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,TIPO_CAFE,EXPORTADOR,COMPROMISO " +
                    "FROM `mas+cafecompf19_20ops` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
                Else
                    If (TxtExportador.SelectedValue = " Todos") Then
                        Me.SqlDataSource3.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,TIPO_CAFE,EXPORTADOR,COMPROMISO " +
                        "FROM `mas+cafecompf19_20ops` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
                    Else
                        BAgregar2.Visible = True

                        Me.SqlDataSource3.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,TIPO_CAFE,EXPORTADOR,COMPROMISO " +
                        "FROM `mas+cafecompf19_20ops` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' AND EXPORTADOR='" & TxtExportador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
                    End If
    ...
    Sub llenagrid4()
        ...
        If TxtDepto.SelectedValue = "00" Then
            ...
            "FROM `mas+cafecompf19_20prodno` ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
        Else
            If TxtEntrenador.SelectedValue = "00" Then

                Me.SqlDataSource4.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,ID_PRODUCTOR,NOMBRE,TIPO_CAFE,EXPORTADOR,COMPROMISO " +
                "FROM `mas+cafecompf19_20prodno` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
            Else
                If (cmborganizacion.SelectedValue = "00") Then
                    Me.SqlDataSource4.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,ID_PRODUCTOR,NOMBRE,TIPO_CAFE,EXPORTADOR,COMPROMISO " +
                    "FROM `mas+cafecompf19_20prodno` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
                Else
                    If (TxtExportador.SelectedValue = " Todos") Then
                        Me.SqlDataSource4.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,ID_PRODUCTOR,NOMBRE,TIPO_CAFE,EXPORTADOR,COMPROMISO " +
                        "FROM `mas+cafecompf19_20prodno` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
                    Else
                        BAgregar3.Visible = True
                        BRegistrar.Visible = True

                        Me.SqlDataSource4.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,ID_PRODUCTOR,NOMBRE,TIPO_CAFE,EXPORTADOR,COMPROMISO " +
                        "FROM `mas+cafecompf19_20prodno` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' AND EXPORTADOR='" & TxtExportador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
                    End If
    ...
    Sub llenagrid5()
       ...
       " FROM `registrofnoprodcomp` WHERE COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' AND Eliminado IS NULL ORDER BY NOMBRE "
        'Else
        '    pasarcodin2()

        '    Me.SqlDataSource5.SelectCommand = "SELECT IDENTIDAD,NOMBRE,SEXO,EDAD " +
        '    " FROM `registrofnoprodcomp` WHERE COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' AND Eliminado IS NULL AND IDENTIDAD NOT IN (" & TxtIn.Text & ") ORDER BY NOMBRE "
        'End If
    ...
    Protected Sub GridDatos3_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridDatos3.RowCommand
        ...
        If (e.CommandName = "AgregarComp2") Then
            ...
            Dim Str As String = "SELECT * FROM `mas+cafecompf19_20ops` WHERE  Id='" & HttpUtility.HtmlDecode(gvrow.Cells(0).Text).ToString & "' "
            Dim adap As New MySqlDataAdapter(Str, conn3)
            Dim dt As New DataTable
            adap.Fill(dt)
        ...
        If (e.CommandName = "Eliminar2") Then
            ...
            Dim Str As String = "SELECT * FROM cafecomp19_20fops WHERE  Id='" & HttpUtility.HtmlDecode(gvrow.Cells(0).Text).ToString & "' "
            Dim adap As New MySqlDataAdapter(Str, conn3)
            Dim dt As New DataTable
            adap.Fill(dt)
    ...
    Protected Sub GridDatos4_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridDatos4.RowCommand
        ...
        If (e.CommandName = "AgregarComp3") Then
            ...
            Dim Str As String = "SELECT * FROM `mas+cafecompf19_20prodno` WHERE  Id='" & HttpUtility.HtmlDecode(gvrow.Cells(0).Text).ToString & "' "
            Dim adap As New MySqlDataAdapter(Str, conn3)
            Dim dt As New DataTable
            adap.Fill(dt)
        ...
        If (e.CommandName = "Eliminar3") Then
            ...
            Dim Str As String = "SELECT * FROM cafecomp19_20fprodno WHERE  Id='" & HttpUtility.HtmlDecode(gvrow.Cells(0).Text).ToString & "' "
            Dim adap As New MySqlDataAdapter(Str, conn3)
            Dim dt As New DataTable
            adap.Fill(dt)
    ...
    Protected Sub BGuardar3_Click(sender As Object, e As EventArgs) Handles BGuardar3.Click
        ...
        If (TxtID2.Text > 0) Then
            Sql = "UPDATE cafecomp19_20fops SET COMPROMISO=@COMPROMISO,TIPO_CAFE=@TIPO_CAFE,PRODUCTORES=@PRODUCTORES,FECHA=now() WHERE Id=" & TxtID2.Text & " "
            cmd2.Connection = conex
            cmd2.CommandText = Sql
        ...
        Else
            Sql = "INSERT INTO cafecomp19_20fops (COD_ORGANIZACION,EXPORTADOR,COMPROMISO,TIPO_CAFE,FECHA,PRODUCTORES) VALUES (@COD_ORGANIZACION,@EXPORTADOR,@COMPROMISO,@TIPO_CAFE,now(),@PRODUCTORES) "
            cmd2.Connection = conex
            cmd2.CommandText = Sql
    ...
    Protected Sub BGuardar4_Click(sender As Object, e As EventArgs) Handles BGuardar4.Click
        ...
        Sql = "INSERT INTO registrofnoprodcomp (COD_ORGANIZACION,IDENTIDAD,NOMBRE,SEXO,EDAD,TELEFONO,CARGO,FECHA) VALUES (@COD_ORGANIZACION,@IDENTIDAD,@NOMBRE,@SEXO,@EDAD,@TELEFONO,@CARGO,now()) "
        cmd2.Connection = conex
        cmd2.CommandText = Sql
    ...
    Protected Sub BGuardar5_Click(sender As Object, e As EventArgs) Handles BGuardar5.Click
        ...
        For Each row As GridViewRow In GridDatos5.Rows
            ...
            If check.Checked Then
                ...
                Sql = "INSERT INTO cafecomp19_20fprodno (ID_PRODUCTOR,COD_ORGANIZACION,EXPORTADOR,COMPROMISO,IDENTIDAD,COMPBLANCO,FECHA) VALUES (@ID_PRODUCTOR,@COD_ORGANIZACION,@EXPORTADOR,0,@IDENTIDAD,1,now()) "
                cmd2.Connection = conex
                cmd2.CommandText = Sql
    ...
    Protected Sub BGuardar6_Click(sender As Object, e As EventArgs) Handles BGuardar6.Click
        ...
        Sql = "UPDATE cafecomp19_20fprodno SET TIPO_CAFE=@TIPO_CAFE,COMPROMISO=@COMPROMISO,RTN=@RTN,CLAVE_IHCAFE=@CLAVE_IHCAFE,FECHA=now(),COMPBLANCO=0 WHERE Id=" & TxtID3.Text & " "
        cmd2.Connection = conex
        cmd2.CommandText = Sql
    ...
    Protected Sub BBorrarsi_Click(sender As Object, e As EventArgs) Handles BBorrarsi.Click
        ...
        If (TxtID2.Text > 0) Then
            Sql = "UPDATE cafecomp19_20fops SET Eliminado=1  WHERE Id=" & TxtID2.Text & " "
            cmd.Connection = conex
            cmd.CommandText = Sql
            cmd.ExecuteNonQuery()
            'llenagrid3()
        ...
        If (TxtID3.Text > 0) Then
            Sql = "UPDATE cafecomp19_20fprodno SET Eliminado=1  WHERE Id=" & TxtID3.Text & " "
            'llenagrid4()
        ...
        If (FileUpload1.HasFile AndAlso IO.Path.GetExtension(FileUpload1.FileName) = ".xlsx") Then
            ...
            Using workBook As New XLWorkbook(FileUpload1.PostedFile.InputStream)
                ...
                For x = 0 To dt.Rows.Count - 1
                    If dt.Rows(x)("COMPROMISO") > 0 Then
                        x4 = x4 + 1
                    End If

                    If dt.Rows(x)("Id").ToString = -1 And dt.Rows(x)("COMPROMISO") > 0 Then
                        x3 = x3 + 1

                        Dim cmd2 As New MySqlCommand()

                        conex.Open()
                        Sql = "INSERT INTO `cafecomp19_20prod` (COD_PRODUCTOR,COD_ORGANIZACION,TIPO_CAFE,EXPORTADOR,COMPROMISO,IDENTIDAD,RTN,CLAVE_IHCAFE,COMPBLANCO,FECHA,ES_QQPROD,ES_QQESTIM,SFERT,GFERT_GF_QQFERT,GFERT_GF2_QQFERT2,GFERT_GF2_QQFERT3,GAR_SOLIDARIA,GAR_PRENDARIA,GAR_HIPOTECARIA,SOTROFIN,FIN_TESTER,FIN_SECADORAS,FIN_DESP,FIN_HERRAMIENTAS,AREA_TOTAL,AREA_PRODUCCION,AREA_PLANTILLA) VALUES (@COD_PRODUCTOR,@COD_ORGANIZACION,@TIPO_CAFE,@EXPORTADOR,@COMPROMISO,@IDENTIDAD,@RTN,@CLAVE_IHCAFE,@COMPBLANCO,now(),@ES_QQPROD,@ES_QQESTIM,@SFERT,@GFERT_GF_QQFERT,@GFERT_GF2_QQFERT2,@GFERT_GF2_QQFERT3,@GAR_SOLIDARIA,	@GAR_PRENDARIA,@GAR_HIPOTECARIA,@SOTROFIN,@FIN_TESTER,@FIN_SECADORAS,@FIN_DESP,@FIN_HERRAMIENTAS,@AREA_TOTAL,@AREA_PRODUCCION,@AREA_PLANTILLA) "
                        cmd2.Connection = conex
                        cmd2.CommandText = Sql
                        ...
                        cmd2.Parameters.AddWithValue("@TIPO_CAFE", dt.Rows(x)("TIPO_CAFE").ToString)
                    ...
                    If dt.Rows(x)("Id").ToString <> -1 And dt.Rows(x)("COMPROMISO") > 0 Then
                        ...
                        conex.Open()
                        Sql = "UPDATE `cafecomp19_20prod` SET COD_PRODUCTOR=@COD_PRODUCTOR,	COD_ORGANIZACION=@COD_ORGANIZACION,	TIPO_CAFE=@TIPO_CAFE,	EXPORTADOR=@EXPORTADOR,	COMPROMISO=@COMPROMISO,	IDENTIDAD=@IDENTIDAD,	RTN=@RTN,	CLAVE_IHCAFE=@CLAVE_IHCAFE,	ES_QQPROD=@ES_QQPROD,	ES_QQESTIM=@ES_QQESTIM,	SFERT=@SFERT,	GFERT_GF_QQFERT=@GFERT_GF_QQFERT,	GFERT_GF2_QQFERT2=@GFERT_GF2_QQFERT2,	GFERT_GF2_QQFERT3=@GFERT_GF2_QQFERT3,	GAR_SOLIDARIA=@GAR_SOLIDARIA,	GAR_PRENDARIA=@GAR_PRENDARIA,	GAR_HIPOTECARIA=@GAR_HIPOTECARIA,	SOTROFIN=@SOTROFIN,	FIN_TESTER=@FIN_TESTER,	FIN_SECADORAS=@FIN_SECADORAS,	FIN_DESP=@FIN_DESP,	FIN_HERRAMIENTAS=@FIN_HERRAMIENTAS,	AREA_TOTAL=@AREA_TOTAL,	AREA_PRODUCCION=@AREA_PRODUCCION,	AREA_PLANTILLA=@AREA_PLANTILLA WHERE Id='" & dt.Rows(x)("Id") & "' "
                        cmd2.Connection = conex
                        cmd2.CommandText = Sql
