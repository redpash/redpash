...
Public Class CRCompromisosOPSfpr19
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CRCompromisosOPSfpr19.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MAS_PMSU.CRCompromisosOPSfpr19.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCompromisosOPSfpr19
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCompromisosOPSfpr19 = New CRCompromisosOPSfpr19()
        rpt.Site = Me.Site
        Return rpt
    End Function
