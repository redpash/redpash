...
Public Class compromisosopsaseconv19_20
    ...
    Sub llenagrid()
        ...
        If TxtDepto.SelectedValue = "00" Then
            ...
            "FROM `mas+cafecomp19_20resumen2` ORDER BY Depto_Descripcion,OP_NOMBRE,EXPORTADOR "
        Else
            If (TxtOrg.SelectedValue = " Todos") Then
                Me.SqlDataSource1.SelectCommand = "SELECT Depto_Descripcion,OP_NOMBRE,EXPORTADOR,QQ_PS,CONVENIO_OP " +
                "FROM `mas+cafecomp19_20resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,OP_NOMBRE,EXPORTADOR "

            Else
                Me.SqlDataSource1.SelectCommand = "SELECT Depto_Descripcion,OP_NOMBRE,EXPORTADOR,QQ_PS,CONVENIO_OP " +
                "FROM `mas+cafecomp19_20resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND EXPORTADOR='" & TxtOrg.SelectedValue & "' ORDER BY Depto_Descripcion,OP_NOMBRE,EXPORTADOR "
    ...
    Sub llenagrid2()
       ...
       " FROM `mas+cafecomp19_20resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND EXPORTADOR='" & TxtOrg.SelectedValue & "' ORDER BY OP_NOMBRE "
    ...
    Private Sub revisarorg()
        Dim sql As String = "SELECT * FROM `cafecomp19_20opsconv` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND	EXPORTADOR='" & TxtOrg.SelectedValue & "' "
    ...
    Private Sub exportar()
        ...
        If TxtDepto.SelectedValue = "00" Then
            query = "SELECT * FROM `mas+cafecomp19_20resumen2` ORDER BY Depto_Descripcion,OP_NOMBRE,EXPORTADOR "
        Else
            If (TxtOrg.SelectedValue = " Todos") Then
                query = "SELECT * FROM `mas+cafecomp19_20resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,OP_NOMBRE,EXPORTADOR "

            Else
                query = "SELECT * FROM `mas+cafecomp19_20resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND EXPORTADOR='" & TxtOrg.SelectedValue & "' ORDER BY Depto_Descripcion,OP_NOMBRE,EXPORTADOR "
    ...
    Protected Sub BGuardarr_Click(sender As Object, e As EventArgs) Handles BGuardar.Click
        ...
        conex.Open()
        Sql = "DELETE FROM `cafecomp19_20opsconv` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND EXPORTADOR='" & TxtOrg.SelectedValue & "' "
        cmd.Connection = conex
        cmd.CommandText = Sql
        cmd.ExecuteNonQuery()
        conex.Close()
        ...
        For Each row As GridViewRow In GridDatos2.Rows
            ...
            If check.Checked Then
                ...
                Sql = "INSERT INTO cafecomp19_20opsconv (Depto_Cod,COD_ORGANIZACION,EXPORTADOR,Fecha) VALUES (@Depto_Cod,@COD_ORGANIZACION,@EXPORTADOR,@Fecha) "
