...
Public Class registro_organizaciones
    ...
    Private Sub llenarcomboEntrenador()
        Dim StrCombo As String = "SELECT '00' as ec_codigo,' Todos' as ec_nombre UNION SELECT DISTINCT ec_codigo, ec_nombre FROM `mas+registro_productores` WHERE Depto_Cod = '" & TxtDepto.SelectedValue & "' ORDER BY ec_nombre"
        Dim adaptcombo As New MySqlDataAdapter(StrCombo, conn)
        Dim DtCombo As New DataTable
        adaptcombo.Fill(DtCombo)
    ...
    Sub llenagrid()
        ...
        If TxtDepto.SelectedValue = "00" Then
            ...
            "FROM `mas+entrenamientos_calidad` ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
        Else
            If TxtEntrenador.SelectedValue = "00" Then
                Me.SqlDataSource1.SelectCommand = "SELECT id,id2,Depto_Descripcion,ec_nombre,mod_nombre,fecha,OP_NOMBRE,COD_PRODUCTOR,NOMBRE,SEXO " +
                "FROM `mas+entrenamientos_calidad` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
            Else
                If (cmborganizacion.SelectedValue = "00") Then
                    Me.SqlDataSource1.SelectCommand = "SELECT id,id2,Depto_Descripcion,ec_nombre,mod_nombre,fecha,OP_NOMBRE,COD_PRODUCTOR,NOMBRE,SEXO " +
                    "FROM `mas+entrenamientos_calidad` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
                Else
                    If (TxtTema.SelectedValue = "00") Then
                        Me.SqlDataSource1.SelectCommand = "SELECT id,id2,Depto_Descripcion,ec_nombre,mod_nombre,fecha,OP_NOMBRE,COD_PRODUCTOR,NOMBRE,SEXO " +
                        "FROM `mas+entrenamientos_calidad` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
                    Else
                        Me.SqlDataSource1.SelectCommand = "SELECT id,id2,Depto_Descripcion,ec_nombre,mod_nombre,fecha,OP_NOMBRE,COD_PRODUCTOR,NOMBRE,SEXO " +
                        "FROM `mas+entrenamientos_calidad` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' AND mod_codigo='" & TxtTema.SelectedValue & "'  ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
    ...
    Sub llenagrid2()
       ...
       " FROM `mas+registro_productores` WHERE COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' ORDER BY NOMBRE "
    ...
    Private Sub exportar()
        ...
        If TxtDepto.SelectedValue = "00" Then
            query = "SELECT * FROM `mas+entrenamientos_calidad` ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
        Else
            If TxtEntrenador.SelectedValue = "00" Then
                query = "SELECT * FROM `mas+entrenamientos_calidad` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
            Else
                If (cmborganizacion.SelectedValue = "00") Then
                    query = "SELECT * FROM `mas+entrenamientos_calidad` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
                Else
                    If (TxtTema.SelectedValue = "00") Then
                        query = "SELECT * FROM `mas+entrenamientos_calidad` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
                    Else
                        query = "SELECT * FROM `mas+entrenamientos_calidad` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' AND mod_codigo='" & TxtTema.SelectedValue & "'  ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
    ...
    Protected Sub GridDatos_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridDatos.RowCommand
        ...
        If (e.CommandName = "Eliminar") Then
            ...
            Dim Str As String = "SELECT * FROM `mas+entrenamientos_calidad` WHERE  id2='" & HttpUtility.HtmlDecode(gvrow.Cells(2).Text).ToString & "' "
            ...
            Dim Str2 As String = "SELECT * FROM `mas+entrenamientos_calidad` WHERE  id2='" & HttpUtility.HtmlDecode(gvrow.Cells(2).Text).ToString & "' "
    ...
    Protected Sub BGuardar_Click(sender As Object, e As EventArgs) Handles BGuardar.Click
        ...
        If (GridDatos.Rows.Count = 0) Then
            ...
            Sql = "INSERT INTO capacitaciones_calidad (mod_codigo,fecha,catador,COD_ORGANIZACION,fecha_ingreso) VALUES (@mod_codigo,@fecha,@catador,@COD_ORGANIZACION,now()) "
            ...
            cmd.Parameters.AddWithValue("@catador", System.Web.HttpContext.Current.Session("codigo"))
            cmd.Parameters.AddWithValue("@COD_ORGANIZACION", cmborganizacion.SelectedValue)
            cmd.ExecuteNonQuery()

            Dim cmd2 As New MySqlCommand()
            Sql = "SELECT *  from capacitaciones_calidad ORDER BY Id DESC limit 1 "
            ...
            For Each row As GridViewRow In GridDatos2.Rows
                ...
                If check.Checked Then
                    ...
                    Sql = "INSERT INTO capacitaciones_calidad_prod (Id_parent,COD_PRODUCTOR,fecha_ingreso) VALUES (@Id_parent,@COD_PRODUCTOR,now()) "
        ...
        Else
            ...
            Sql = " UPDATE capacitaciones_calidad  SET fecha=@fecha,catador=@catador WHERE Id=@Id"
            cmd5.Connection = conex
            cmd5.CommandText = Sql
            cmd5.Parameters.AddWithValue("@Id", TxtID.Text)
            cmd5.Parameters.AddWithValue("@catador", System.Web.HttpContext.Current.Session("codigo"))
    ...
    Protected Sub BGuardar2_Click(sender As Object, e As EventArgs) Handles BGuardar2.Click
        ...
        Dim cmd As New MySqlCommand()
        Sql = "INSERT INTO capacitaciones_calidad_noprod (Id_parent,nombre,identidad,sexo,edad,telefono,fecha_ingreso) VALUES (@Id_parent,@nombre,@identidad,@sexo,@edad,telefono,now()) "
        cmd.Connection = conex
        cmd.CommandText = Sql
    ...
    Protected Sub BBorrarsi_Click(sender As Object, e As EventArgs) Handles BBorrarsi.Click
        ...
        If (TxtTip.Text = "PPM") Then
            Sql = "UPDATE capacitaciones_calidad_prod SET eliminado=1  WHERE id=" & TxtID2.Text & " "
        Else
            Sql = "UPDATE capacitaciones_calidad_noprod SET eliminado=1  WHERE id=" & TxtID2.Text & " "
        End If
