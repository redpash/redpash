...
Public Class CRCompromisosOPS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MAS_PMSU.CRCompromisosOPS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCompromisosOPS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCompromisosOPS = New CRCompromisosOPS()
        rpt.Site = Me.Site
        Return rpt
    End Function
