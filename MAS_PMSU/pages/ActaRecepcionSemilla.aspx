                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox CssClass="form-control" ID="TxtCeduIden" runat="server" AutoPostBack="false" onkeypress="return numericOnly(this);"></asp:TextBox>
                        ...
                        <div id="div1" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtAmadeusHumedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimAmadeus" CssClass="form-control" runat="server"  onkeypress="return numericOnly(this);"></asp:TextBox>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutAmadeus" CssClass="form-control" runat="server"  onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="div2" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtCarrizalitoHumedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimCarrizalito" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label>Peso Bruto:</label>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutCarrizalito" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="div3" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtDeorhoHumedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimDeorho" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label>Peso Bruto:</label>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutDeorho" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="div4" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtAzabacheHumedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimAzabache" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label>Peso Bruto:</label>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutAzabache" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="div5" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtParaisitoMejoradoPM2Humedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>                
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimParaisitoMejoradoPM2" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label>Peso Bruto:</label>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutParaisitoMejoradoPM2" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="div6" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtHondurasnutritivoHumedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimHondurasnutritivo" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label>Peso Bruto:</label>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutHondurasnutritivo" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="div7" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtIntaCardenasHumedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimIntaCardenas" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label>Peso Bruto:</label>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutIntaCardenas" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="div8" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtLencaprecozHumedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimLencaprecoz" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label>Peso Bruto:</label>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutLencaprecoz" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="div9" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtRojochortiHumedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimRojochorti" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label>Peso Bruto:</label>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutRojochorti" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="div10" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtTolupanrojoHumedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimTolupanrojo" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label>Peso Bruto:</label>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutTolupanrojo" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="div11" runat="server">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtOtravariedadHumedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label># Bultos:</label>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtPesoPrimOtravariedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                    <label>Peso Bruto:</label>
                                    ...
                                    <asp:TextBox ID="txtPesoBrutOtravariedad" CssClass="form-control" runat="server" onkeypress="return numericOnly(this);"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
