<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="entrenamientoscalidad2019.aspx.vb" Inherits="MAS_PMSU.entrenamientoscalidad2019" %>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    CAPACITACIONES EN CALIDAD A ORGANIZACIONES 2019
                </div>
                        ...
                        <div class="tab-pane fade in active" id="Datos">
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <%--<script type="text/javascript" src='../vendor/jquery/jquery-1.8.3.min.js'></script>--%>
                                        <asp:TextBox ID="TxtCod"  Visible="false" runat="server"></asp:TextBox>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                                    <ContentTemplate>
                                                        <asp:GridView ID="GridDatos2" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                                            GridLines="None" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" DataSourceID="SqlDataSource2" Font-Size="Small" OnPageIndexChanging="GridDatos2_PageIndexChanging" PageSize="150" PageIndex="0">
