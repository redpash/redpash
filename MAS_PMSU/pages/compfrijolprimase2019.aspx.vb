...
Public Class compfrijolprimase2019
    ...
    Sub llenagrid3()
        ...
        If TxtDepto.SelectedValue = "00" Then
            ...
            "FROM `mas+frijolcompri19ops` ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
        Else
            If TxtEntrenador.SelectedValue = "00" Then

                Me.SqlDataSource3.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,EXPORTADOR,VARIEDAD,COMPROMISO " +
                "FROM `mas+frijolcompri19ops` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
            Else
                If (cmborganizacion.SelectedValue = "00") Then
                    Me.SqlDataSource3.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,EXPORTADOR,VARIEDAD,COMPROMISO " +
                    "FROM `mas+frijolcompri19ops` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
                Else
                    If (TxtExportador.SelectedValue = " Todos") Then
                        Me.SqlDataSource3.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,EXPORTADOR,VARIEDAD,COMPROMISO " +
                        "FROM `mas+frijolcompri19ops` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
                    Else
                        BAgregar2.Visible = True

                        Me.SqlDataSource3.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,EXPORTADOR,VARIEDAD,COMPROMISO " +
                        "FROM `mas+frijolcompri19ops` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' AND EXPORTADOR='" & TxtExportador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
                    End If
    ...
    Sub llenagrid4()
        ...
        If TxtDepto.SelectedValue = "00" Then
            ...
            "FROM `mas+frijolcompri19prodno` ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
        Else
            If TxtEntrenador.SelectedValue = "00" Then

                Me.SqlDataSource4.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,ID_PRODUCTOR,NOMBRE,EXPORTADOR,VARIEDAD,COMPROMISO " +
                "FROM `mas+frijolcompri19prodno` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
            Else
                If (cmborganizacion.SelectedValue = "00") Then
                    Me.SqlDataSource4.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,ID_PRODUCTOR,NOMBRE,EXPORTADOR,VARIEDAD,COMPROMISO " +
                    "FROM `mas+frijolcompri19prodno` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
                Else
                    If (TxtExportador.SelectedValue = " Todos") Then
                        Me.SqlDataSource4.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,ID_PRODUCTOR,NOMBRE,EXPORTADOR,VARIEDAD,COMPROMISO " +
                        "FROM `mas+frijolcompri19prodno` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
                    Else
                        BAgregar3.Visible = True
                        BRegistrar.Visible = True

                        Me.SqlDataSource4.SelectCommand = "SELECT Id as id,Depto_Descripcion,ec_nombre,OP_NOMBRE,ID_PRODUCTOR,NOMBRE,EXPORTADOR,VARIEDAD,COMPROMISO " +
                        "FROM `mas+frijolcompri19prodno` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND ec_codigo='" & TxtEntrenador.SelectedValue & "' AND COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' AND EXPORTADOR='" & TxtExportador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE,NOMBRE "
                    End If
    ...
    Sub llenagrid5()
       ...
       " FROM `registronoprodcomp2` WHERE COD_ORGANIZACION='" & cmborganizacion.SelectedValue & "' AND Eliminado IS NULL ORDER BY NOMBRE "
    ...
    Protected Sub GridDatos3_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridDatos3.RowCommand
        ...
        If (e.CommandName = "AgregarComp2") Then
            ...
            Dim Str As String = "SELECT * FROM `mas+frijolcompri19ops` WHERE  Id='" & HttpUtility.HtmlDecode(gvrow.Cells(0).Text).ToString & "' "
            Dim adap As New MySqlDataAdapter(Str, conn3)
            Dim dt As New DataTable
            adap.Fill(dt)
    ...
    Protected Sub GridDatos4_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridDatos4.RowCommand
        ...
        If (e.CommandName = "AgregarComp3") Then
            ...
            Dim Str As String = "SELECT * FROM `mas+frijolcompri19prodno` WHERE  Id='" & HttpUtility.HtmlDecode(gvrow.Cells(0).Text).ToString & "' "
            Dim adap As New MySqlDataAdapter(Str, conn3)
            Dim dt As New DataTable
            adap.Fill(dt)
    ...
    Protected Sub BGuardar3_Click(sender As Object, e As EventArgs) Handles BGuardar3.Click
        ...
        If (TxtID2.Text > 0) Then
            Sql = "UPDATE frijolcompri19ops SET COMPROMISO=@COMPROMISO,VARIEDAD=@VARIEDAD,FECHA=now() WHERE Id=" & TxtID2.Text & " "
            cmd2.Connection = conex
            cmd2.CommandText = Sql
        ...
        Else
            Sql = "INSERT INTO frijolcompri19ops (COD_ORGANIZACION,EXPORTADOR,COMPROMISO,VARIEDAD,FECHA) VALUES (@COD_ORGANIZACION,@EXPORTADOR,@COMPROMISO,@VARIEDAD,now()) "
            cmd2.Connection = conex
            cmd2.CommandText = Sql
    ...
    Protected Sub BGuardar4_Click(sender As Object, e As EventArgs) Handles BGuardar4.Click
        ...
        Sql = "INSERT INTO registronoprodcomp2 (COD_ORGANIZACION,IDENTIDAD,NOMBRE,SEXO,EDAD,TELEFONO,CARGO,FECHA) VALUES (@COD_ORGANIZACION,@IDENTIDAD,@NOMBRE,@SEXO,@EDAD,@TELEFONO,@CARGO,now()) "
        cmd2.Connection = conex
        cmd2.CommandText = Sql
    ...
    Protected Sub BGuardar5_Click(sender As Object, e As EventArgs) Handles BGuardar5.Click
        ...
        For Each row As GridViewRow In GridDatos5.Rows
            ...
            If check.Checked Then
                ...
                Sql = "INSERT INTO frijolcompri19prodno (ID_PRODUCTOR,COD_ORGANIZACION,EXPORTADOR,COMPROMISO,IDENTIDAD,COMPBLANCO,FECHA) VALUES (@ID_PRODUCTOR,@COD_ORGANIZACION,@EXPORTADOR,0,@IDENTIDAD,1,now()) "
                cmd2.Connection = conex
                cmd2.CommandText = Sql
    ...
    Protected Sub BGuardar6_Click(sender As Object, e As EventArgs) Handles BGuardar6.Click
        ...
        Sql = "UPDATE frijolcompri19prodno SET COMPROMISO=@COMPROMISO,RTN=@RTN,VARIEDAD=@VARIEDAD,FECHA=now(),COMPBLANCO=0 WHERE Id=" & TxtID3.Text & " "
        cmd2.Connection = conex
        cmd2.CommandText = Sql
    ...
    Protected Sub BBorrarsi_Click(sender As Object, e As EventArgs) Handles BBorrarsi.Click
        ...
        If (TxtID2.Text > 0) Then
            Sql = "UPDATE frijolcompri19ops SET Eliminado=1  WHERE Id=" & TxtID2.Text & " "
            cmd.Connection = conex
            cmd.CommandText = Sql
            cmd.ExecuteNonQuery()
            'llenagrid3()
        ...
        If (TxtID3.Text > 0) Then
            Sql = "UPDATE frijolcompri19prodno SET Eliminado=1  WHERE Id=" & TxtID3.Text & " "
            'llenagrid4()
