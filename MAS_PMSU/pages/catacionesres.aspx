<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="catacionesres.aspx.vb" Inherits="MAS_PMSU.catacionesres" %>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="table-responsive">
                                            <h3>
                                                <span style="float: right;"><small>Total de Cataciones:</small>
                                            ...
                                            <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:BoundField DataField="Catacion" HeaderText="CATACION" />
                                                </Columns>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:Button ID="BAgregar" runat="server" class="btn btn-success" Text="Catacion OP" />
                                        <asp:Button ID="BAgregar2" runat="server" class="btn btn-primary" Text="Catacion Productor" />
