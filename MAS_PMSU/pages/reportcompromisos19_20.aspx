<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="reportcompromisos19_20.aspx.vb" Inherits="MAS_PMSU.reportcompromisos19_20" %>
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                    ...
                                    <Columns>                                        
                                        ...
                                        <asp:BoundField DataField="QQ_PS" HeaderText="COMPROMISO" DataFormatString="{0:0.00}" />
