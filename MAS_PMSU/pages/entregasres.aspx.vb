...
Public Class entregasres
    ...
    Private Sub llenarcombodepto()
        Dim StrCombo As String = "SELECT '00' as Depto_Cod,' Todos' as Departamento UNION SELECT DISTINCT Depto_Cod,Departamento FROM `codigos_op_17-02-2018` ORDER BY Departamento "
    ...
    Private Sub llenarcomboorg()
        ...
        Dim StrCombo As String = "SELECT '00' as op_codigo,' Todas' as op_nombre UNION SELECT DISTINCT op_codigo,op_nombre FROM `codigos_op_fortalecidas` WHERE Cod_depto='" & TxtDepto.SelectedValue & "' ORDER BY op_nombre "
        Dim adaptcombo As New MySqlDataAdapter(StrCombo, conn2)
        Dim DtCombo As New DataTable
        adaptcombo.Fill(DtCombo)
    ...
    Sub llenagrid()
        ...
        If TxtDepto.SelectedValue = "00" Then
            Me.SqlDataSource1.SelectCommand = "SELECT Id,Depto_Descripcion,COD_ORGANIZACION,OP_NOMBRE,Fecha,NotaPeso,Entrega,Exportador,Entrega,Peso,Por_Dano,Por_Hum,Peso_Final " +
            "FROM `mas+cafe_entregas_fortalecidas` ORDER BY Fecha,Depto_Descripcion,OP_NOMBRE "
        Else
            If (TxtOrg.SelectedValue = "00") Then
                Me.SqlDataSource1.SelectCommand = "SELECT Id,Depto_Descripcion,COD_ORGANIZACION,OP_NOMBRE,Fecha,NotaPeso,Entrega,Exportador,Entrega,Peso,Por_Dano,Por_Hum,Peso_Final " +
                "FROM `mas+cafe_entregas_fortalecidas` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Fecha,Depto_Descripcion,OP_NOMBRE "

            Else
                Me.SqlDataSource1.SelectCommand = "SELECT Id,Depto_Descripcion,COD_ORGANIZACION,OP_NOMBRE,Fecha,NotaPeso,Entrega,Exportador,Entrega,Peso,Por_Dano,Por_Hum,Peso_Final " +
                "FROM `mas+cafe_entregas_fortalecidas` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND COD_ORGANIZACION='" & TxtOrg.SelectedValue & "' ORDER BY Fecha,Depto_Descripcion,OP_NOMBRE "
            ...
            Using cmd As New MySqlCommand(query)
                Using sda As New MySqlDataAdapter()
                    ...
                    Using ds As New DataSet()
                        ...
                        ds.Tables(0).TableName = "mas+cafe_entregas_fortalecidas"
                        ...
                        Using wb As New XLWorkbook()
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=mas+cafe_entregas_fortalecidas " & Today & ".xlsx")
