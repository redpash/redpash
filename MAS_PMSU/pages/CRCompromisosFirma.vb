...
Public Class CRCompromisosFirma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MAS_PMSU.CRCompromisosFirma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRCompromisosFirma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRCompromisosFirma = New CRCompromisosFirma()
        rpt.Site = Me.Site
        Return rpt
    End Function
