...
Public Class compfrijolprimasefconv2019
    ...
    Private Sub llenarcombodepto()
        Dim StrCombo As String = "SELECT '00' as Depto_Cod,' Todos' as Depto_Descripcion UNION SELECT DISTINCT Depto_Cod,Depto_Descripcion FROM `mas+frijolcomprif19resumen2` ORDER BY Depto_Descripcion "
    ...
    Private Sub llenarcomboorg()
        ...
        Dim StrCombo As String = "SELECT ' Todos' as COMPRADOR UNION SELECT DISTINCT COMPRADOR FROM `mas+frijolcomprif19resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY COMPRADOR "
        Dim adaptcombo As New MySqlDataAdapter(StrCombo, conn)
        Dim DtCombo As New DataTable
        adaptcombo.Fill(DtCombo)
    ...
    Sub llenagrid()
        ...
        If TxtDepto.SelectedValue = "00" Then
            Me.SqlDataSource1.SelectCommand = "SELECT Depto_Descripcion,OP_NOMBRE,COMPRADOR,QQ_COMPROMETIDOS,CONTRATO_OP " +
            "FROM `mas+frijolcomprif19resumen2` ORDER BY Depto_Descripcion,OP_NOMBRE,COMPRADOR "
        Else
            If (TxtOrg.SelectedValue = " Todos") Then
                Me.SqlDataSource1.SelectCommand = "SELECT Depto_Descripcion,OP_NOMBRE,COMPRADOR,QQ_COMPROMETIDOS,CONTRATO_OP " +
                "FROM `mas+frijolcomprif19resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,OP_NOMBRE,COMPRADOR "

            Else
                Me.SqlDataSource1.SelectCommand = "SELECT Depto_Descripcion,OP_NOMBRE,COMPRADOR,QQ_COMPROMETIDOS,CONTRATO_OP " +
                "FROM `mas+frijolcomprif19resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND COMPRADOR='" & TxtOrg.SelectedValue & "' ORDER BY Depto_Descripcion,OP_NOMBRE,COMPRADOR "
    ...
    Sub llenagrid2()
        ...
        Me.SqlDataSource2.SelectCommand = "SELECT COD_ORGANIZACION,OP_NOMBRE,COMPRADOR,QQ_COMPROMETIDOS " +
       " FROM `mas+frijolcomprif19resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND COMPRADOR='" & TxtOrg.SelectedValue & "' ORDER BY OP_NOMBRE "
    ...
    Private Sub revisarorg()
        Dim sql As String = "SELECT * FROM `frijolcompri19fopsconv` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND	EXPORTADOR='" & TxtOrg.SelectedValue & "' "
    ...
    Private Sub exportar()
        ...
        If TxtDepto.SelectedValue = "00" Then
            query = "SELECT * FROM `mas+frijolcomprif19resumen2` ORDER BY Depto_Descripcion,OP_NOMBRE,COMPRADOR "
        Else
            If (TxtOrg.SelectedValue = " Todos") Then
                query = "SELECT * FROM `mas+frijolcomprif19resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,OP_NOMBRE,COMPRADOR "

            Else
                query = "SELECT * FROM `mas+frijolcomprif19resumen2` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND COMPRADOR='" & TxtOrg.SelectedValue & "' ORDER BY Depto_Descripcion,OP_NOMBRE,COMPRADOR "
            End If
            ...
            Using cmd As New MySqlCommand(query)
                Using sda As New MySqlDataAdapter()
                    ...
                    Using ds As New DataSet()
                        ...
                        ds.Tables(0).TableName = "mas+frijolfcompprim19"
                        ...
                        Using wb As New XLWorkbook()
                            ...
                            Response.AddHeader("content-disposition", "attachment;filename=mas+frijolfcompprim19 " & Today & ".xlsx")
    ...
    Protected Sub BGuardarr_Click(sender As Object, e As EventArgs) Handles BGuardar.Click
        ...
        conex.Open()
        Sql = "DELETE FROM `frijolcompri19fopsconv` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND EXPORTADOR='" & TxtOrg.SelectedValue & "' "
        cmd.Connection = conex
        cmd.CommandText = Sql
        cmd.ExecuteNonQuery()
        conex.Close()
        ...
        For Each row As GridViewRow In GridDatos2.Rows
            ...
            If check.Checked Then
                ...
                Sql = "INSERT INTO frijolcompri19fopsconv (Depto_Cod,COD_ORGANIZACION,EXPORTADOR,Fecha) VALUES (@Depto_Cod,@COD_ORGANIZACION,@EXPORTADOR,@Fecha) "
    ...
    Protected Sub BAgregar_Click(sender As Object, e As EventArgs) Handles BAgregar.Click
        ...
        Dim Str As String = "SELECT * FROM `frijolcompri19fopsconv` WHERE Depto_Cod='" & TxtDepto.SelectedValue & "' AND EXPORTADOR='" & TxtOrg.SelectedValue & "' "
        Dim adap As New MySqlDataAdapter(Str, conn)
        Dim dt As New DataTable
        adap.Fill(dt)
