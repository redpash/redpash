<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/principal.Master" CodeBehind="Registro_ops_new.aspx.vb" Inherits="MAS_PMSU.Registro_ops_new" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                REGISTRO DE ORGANIZACIONES DE Red Pash
                            </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="table-responsive">
                                                        ...
                                                        <asp:GridView ID="GridDatos" runat="server" CellPadding="4" ForeColor="#333333" Width="100%"
                                                            GridLines="None" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-bordered table-hover" DataSourceID="SqlDataSource1"  PageSize="8" Font-Size="Small">
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:BoundField DataField="SOCIOS_ORIGINAL_HOMBRES" HeaderText="SOCIOS HOMBRES" />
                                                                <asp:BoundField DataField="SOCIOS_ORIGINAL_MUJERES" HeaderText="SOCIOS MUJERES" />
                  ...
                  <asp:TextBox ID="TextBox1" Visible="false" runat="server"></asp:TextBox>
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <%--boton genera el almacen de div prod --%>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabela22">REDPASH</h5>
                                                    </div>
    ...
    <div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">RedPash</h5>
