...
Public Class reportrescomfrijolpri19
    ...
    Sub llenagrid()
        ...
        If TxtDepto.SelectedValue = "00" Then
            ...
            "FROM `mas+frijolcompri19resumenfirm` ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
        Else
            If TxtEntrenador.SelectedValue = "00" Then
                Me.SqlDataSource1.SelectCommand = "SELECT Id as id,Depto_Descripcion,Muni_Descripcion,COD_ORGANIZACION,OP_NOMBRE,REPRESENTANTE_NOMBRE,EXPORTADOR,COMPROMISO " +
                "FROM `mas+frijolcompri19resumenfirm` WHERE Depto_Firma='" & TxtDepto.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
            Else
                If (TxtExportador.SelectedValue = " Todos") Then
                    Me.SqlDataSource1.SelectCommand = "SELECT Id as id,Depto_Descripcion,Muni_Descripcion,COD_ORGANIZACION,OP_NOMBRE,REPRESENTANTE_NOMBRE,EXPORTADOR,COMPROMISO " +
                    "FROM `mas+frijolcompri19resumenfirm` WHERE Depto_Firma='" & TxtDepto.SelectedValue & "' AND Muni_Firma='" & TxtEntrenador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
                Else
                    BAgregar.Visible = True
                    Me.SqlDataSource1.SelectCommand = "SELECT Id as id,Depto_Descripcion,Muni_Descripcion,COD_ORGANIZACION,OP_NOMBRE,REPRESENTANTE_NOMBRE,EXPORTADOR,COMPROMISO " +
                    "FROM `mas+frijolcompri19resumenfirm` WHERE Depto_Firma='" & TxtDepto.SelectedValue & "' AND Muni_Firma='" & TxtEntrenador.SelectedValue & "' AND EXPORTADOR='" & TxtExportador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
                End If
            End If
        End If
    ...
    Sub llenagrid2()
        ...
        If (GridDatos.Rows.Count = 0) Then
            ...
            "FROM `mas+frijolcompri19resumen2` WHERE  Depto_Cod='" & TxtDepto2.SelectedValue & "' AND Muni_Descripcion='" & TxtMuni2.SelectedValue & "' AND EXPORTADOR='" & TxtExportador.SelectedValue & "' ORDER BY OP_NOMBRE "
        Else
            pasarcodin()

            Me.SqlDataSource2.SelectCommand = "SELECT COD_ORGANIZACION,OP_NOMBRE,REPRESENTANTE_NOMBRE,QQ_PS " +
            "FROM `mas+frijolcompri19resumen2` WHERE  Depto_Cod='" & TxtDepto2.SelectedValue & "' AND Muni_Descripcion='" & TxtMuni2.SelectedValue & "' AND EXPORTADOR='" & TxtExportador.SelectedValue & "' AND COD_ORGANIZACION NOT IN (" & TxtIn.Text & ") ORDER BY OP_NOMBRE "
        End If
    ...
    Protected Sub GridDatos_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GridDatos.RowCommand
        ...
        If (e.CommandName = "Eliminar") Then
            ...
            Dim Str As String = "SELECT * FROM `mas+frijolcompri19resumenfirm` WHERE  Id='" & HttpUtility.HtmlDecode(gvrow.Cells(0).Text).ToString & "' "
    ...
    Private Sub guardarprod()
        ...
        For Each row As GridViewRow In GridDatos2.Rows
            ...
            If check.Checked Then
                ...
                Sql = "INSERT INTO frijolcompri19xfirm (Depto_Firma,Muni_Firma,COD_ORGANIZACION,EXPORTADOR,COMPROMISO,FECHA) VALUES (@Depto_Firma,@Muni_Firma,@COD_ORGANIZACION,@EXPORTADOR,@COMPROMISO,now()) "
    ...
    Protected Sub BBorrarsi_Click(sender As Object, e As EventArgs) Handles BBorrarsi.Click
        ...
        conex.Open()
        Sql = "DELETE FROM frijolcompri19xfirm WHERE Id=" & TxtID.Text & " "
    ...
    Private Sub cargarreporte()
        ...
        stropsres = "SELECT * FROM `mas+frijolcompri19resumenfirm` WHERE Depto_Firma='" & TxtDepto.SelectedValue & "' AND Muni_Firma='" & TxtEntrenador.SelectedValue & "' AND EXPORTADOR='" & TxtExportador.SelectedValue & "' ORDER BY Depto_Descripcion,ec_nombre,OP_NOMBRE "
        ...
        crystalReport.Load(Server.MapPath("~/pages/CRCompromisosFirmafpr19.rpt"))
